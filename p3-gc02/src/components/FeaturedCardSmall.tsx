...
export default function FeaturedCardSmall({ product }: ProductCardProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative h-96 w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-1000"
    >
      <img
