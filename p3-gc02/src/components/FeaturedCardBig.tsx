...
export default function FeaturedCardBig({ product }: ProductCardProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="group relative h-96 w-[30rem] cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-1000"
    >
      <img
        ...
        alt=""
      />
      <div className="invisible absolute inset-0 bg-gradient-to-b from-gray to-black group-hover:visible">
        <div className="absolute inset-x-5 bottom-6">
          <div className="flex gap-3 text-white">
            ...
            <div>
              ...
              <p className="text-gray-300">{formatRupiah(product.price)}</p>
            </div>
          </div>
