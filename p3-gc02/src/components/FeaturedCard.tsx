export default function FeaturedCards() {
  return (
    <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
      <a
        href="#"
        className="group rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300 ease-in-out"
      >
        <img
        ...
        <div className="p-4 bg-gray-100 flex justify-between items-center">
          ...
          <svg
            className="h-6 w-6 fill-current text-gray-500 transition-colors group-hover:text-black"
